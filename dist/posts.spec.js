...
const data = __importStar(require('../data/test_data/posts.js'));
    ...
    it('GET all posts', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_2
          ...
          .to.be.jsonSchema(posts_1.getAllPostsResponseSchema);
      }));
    it('POST post', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_2
          .expect(response.data.result)
          .to.be.jsonSchema(posts_1.postPostsResponseSchema);
      }));
    it('GET user by Id', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_2
          .expect(response.data.result)
          .to.be.jsonSchema(posts_1.getPostByIdResponseSchema);
      }));
    it('PUT user by Id', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_2
          .expect(response.data.result)
          .to.be.jsonSchema(posts_1.putPostsResponseSchema);
      }));
